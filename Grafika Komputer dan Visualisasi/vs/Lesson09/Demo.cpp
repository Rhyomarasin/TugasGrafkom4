...
void Demo::Render() {
	...
	glm::vec3 cameraPos = glm::vec3(0, 5, 6);
...
void Demo::BuildTexturedPaint()
{
	...
	float vertices[] = {
		...
		// front
		-3.8,  1,  0.25, 0,0, 0.0f,  0.0f,  1.0f,   // 0 
		-0.7,  1, 0.25,  1,0, 0.0f,  0.0f,  1.0f,   // 1 
		-0.7,  3, 0.25,  1,1, 0.0f,  0.0f,  1.0f,   // 2 
		-3.8,  3, 0.25,  0,1, 0.0f,  0.0f,  1.0f,   // 3 

		// right
		-0.7,  3, -0.25,  0,0, 1.0f,  0.0f,  0.0f,  // 4
		-0.7,  3, 0.05,   1,0, 1.0f,  0.0f,  0.0f,  // 5 
		-0.7,  1, 0.05,   1,1, 1.0f,  0.0f,  0.0f,  // 6 
		-0.7,  1, -0.25,  0,1, 1.0f,  0.0f,  0.0f,  // 7 

		// back
		-3.8,  1, 0.05, 0,0,  0.0f,  0.0f,  -1.0f,  // 8 
		-0.7,  1, 0.05, 1,0,  0.0f,  0.0f,  -1.0f,  // 9 
		-0.7,  3, 0.05, 1,1,  0.0f,  0.0f,  -1.0f,  // 10 
		-3.8,  3, 0.05, 0,1,  0.0f,  0.0f,  -1.0f,  // 11 

		// left
		-3.8, 1,  0.05,  0,0, -1.0f,  0.0f,  0.0f, // 12   
		-3.8, 1,  -0.25, 1,0, -1.0f,  0.0f,  0.0f, // 13 
		-3.8, 3,  -0.25, 1,1, -1.0f,  0.0f,  0.0f, // 14 
		-3.8, 3,  0.05,  0,1, -1.0f,  0.0f,  0.0f, // 15 

		// upper
		-0.7,  3, 0.25, 0,0,  0.0f,  1.0f,  0.0f,   // 16 
		-3.8,  3, 0.25, 1,0,  0.0f,  1.0f,  0.0f,  // 17 
		-3.8,  3, 0.05, 1,1,  0.0f,  1.0f,  0.0f,  // 18 
		-0.7,  3, 0.05, 0,1,  0.0f,  1.0f,  0.0f,   // 19 

		// bottom
		-3.8,  1, 0.05, 0,0,  0.0f,  -1.0f,  0.0f,  // 20 
		-0.7,  1, 0.05, 1,0,  0.0f,  -1.0f,  0.0f,  // 21 
		-0.7,  1, 0.25, 1,1,  0.0f,  -1.0f,  0.0f,  // 22 
		-3.8,  1, 0.25, 0,1,  0.0f,  -1.0f,  0.0f,  // 23
